package com.example.mapkit.core.util.resource
...
class ResUtilImpl @Inject constructor(
    ...
    override fun getResId(path: String): Int {
        ...
        if (parts.size == 3) {
            ...
            return context.resources.getIdentifier(part2, part1, "com.example.mapkit")
        }
        return 0
    }
    ...
    override fun getStringUpperCase(id: Int): String =
        context.getString(id).uppercase(Locale.getDefault())

    override fun getDrawableId(name: String): Int =
        context.resources.getIdentifier(name, "drawable", "com.example.mapkit")
}
