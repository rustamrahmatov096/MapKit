...
import com.example.mapkit.databinding.DialogDeleteBottomBinding
...
@AndroidEntryPoint
class DeleteBottomDialog : BottomSheetDialogFragment() {

    private var listener: Callback? = null
    private var result: SearchResult? = null
    private val binding by viewBinding(DialogDeleteBottomBinding::bind)

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.dialog_delete_bottom, container, false)
    }
...
//    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnDelete.setOnClickListener {
            result?.let { it1 -> listener?.itemRemove(it1) }
            dismiss()
        }
    ...
    companion object {
        ...
        fun newInstance(listener: Callback,result: SearchResult): DeleteBottomDialog {
            return DeleteBottomDialog().apply {
